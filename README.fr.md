...
[![Catégories](https://img.shields.io/badge/Cat%C3%A9gories-53-9652FF?style=for-the-badge&labelColor=1a1a2e)](#larsenal--53-catégories-28-376-outils)
...
<img src="assets/iw7x-preview.svg" alt="iw7x — arsenal cybersécurité : 28 376 outils dans 53 catégories, conçu pour Kali Linux, par NeoZ" width="840">
...
| | |
|---|---|
| **Tout l'écosystème** | **28 376 outils** dans **53 catégories** — OSINT, web, sans‑fil, exploitation, forensique, reverse, crypto, cloud, Active Directory, mobile, IoT, CTF, honeypots, threat hunting, blue team et bien plus. |
...
## L'arsenal — 53 catégories, 28 376 outils
