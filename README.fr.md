...
**iw7x** réunit **14 469** outils de sécurité offensifs & défensifs — de Nmap à BloodHound, de Metasploit à Volatility — dans un seul arsenal en ligne de commande qui **installe, met à jour et lance** n'importe lequel pour vous. Conçu pour Kali Linux. Gratuit pour toujours.
...
[![Outils](https://img.shields.io/badge/Outils-14%2C469-FF47B3?style=for-the-badge&labelColor=1a1a2e)](catalog.json)
[![Catégories](https://img.shields.io/badge/Cat%C3%A9gories-52-9652FF?style=for-the-badge&labelColor=1a1a2e)](#larsenal--52-catégories-14-469-outils)
...
<img src="assets/iw7x-preview.svg" alt="iw7x — arsenal cybersécurité : 14 469 outils dans 52 catégories, conçu pour Kali Linux, par NeoZ" width="840">
...
| | |
|---|---|
| **Tout l'écosystème** | **14 469 outils** dans **52 catégories** — OSINT, web, sans‑fil, exploitation, forensique, reverse, crypto, cloud, Active Directory, mobile, IoT, CTF, honeypots, threat hunting, blue team et bien plus. |
...
## L'arsenal — 52 catégories, 14 469 outils
