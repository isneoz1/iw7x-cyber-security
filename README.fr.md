...
**iw7x** réunit **30 177** outils de sécurité offensifs & défensifs — de Nmap à BloodHound, de Metasploit à Volatility — dans un seul arsenal en ligne de commande qui **installe, met à jour et lance** n'importe lequel pour vous. Conçu pour Kali Linux. Gratuit pour toujours.
...
[![Outils](https://img.shields.io/badge/Outils-30%2C177-FF47B3?style=for-the-badge&labelColor=1a1a2e)](catalog.json)
[![Catégories](https://img.shields.io/badge/Cat%C3%A9gories-53-9652FF?style=for-the-badge&labelColor=1a1a2e)](#larsenal--53-catégories-30-177-outils)
...
<img src="assets/iw7x-preview.svg" alt="iw7x — arsenal cybersécurité : 30 177 outils dans 53 catégories, conçu pour Kali Linux, par NeoZ" width="840">
...
| | |
|---|---|
| **Tout l'écosystème** | **30 177 outils** dans **53 catégories** — OSINT, web, sans‑fil, exploitation, forensique, reverse, crypto, cloud, Active Directory, mobile, IoT, CTF, honeypots, threat hunting, blue team et bien plus. |
...
> **Pas sur Kali ? iw7x tourne sur tous les appareils** — Windows, macOS, Android, Raspberry Pi, ARM/Apple Silicon et le cloud. La méthode universelle, c'est **Docker** : `docker run -it --rm iw7x`. Voir le **[Guide de compatibilité →](COMPATIBILITY.fr.md)** complet, étape par étape pour chaque plateforme.
...
<a href="https://claude.ai/code/artifact/5210489a-74c0-4eb2-a04f-f33aa3080b3b" target="_blank"><img src="assets/iw7x-demo.svg" alt="iw7x installe et lance Nmap en une seule commande — cliquez pour voir la démo animée complète" width="820"></a>

**[▶ Voir la démo interactive complète →](https://claude.ai/code/artifact/5210489a-74c0-4eb2-a04f-f33aa3080b3b)**
...
## L'arsenal — 53 catégories, 30 177 outils
