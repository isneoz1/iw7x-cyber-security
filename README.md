...
**iw7x** brings **12,663** offensive & defensive security tools — from Nmap to BloodHound, Metasploit to Volatility — into a single command‑line arsenal that **installs, updates and launches** any of them for you. Built for Kali Linux. Free forever.
...
[![Tools](https://img.shields.io/badge/Tools-12%2C663-FF47B3?style=for-the-badge&labelColor=1a1a2e)](catalog.json)
[![Categories](https://img.shields.io/badge/Categories-50-9652FF?style=for-the-badge&labelColor=1a1a2e)](#the-arsenal--50-categories-12663-tools)
...
<img src="assets/iw7x-preview.svg" alt="iw7x — cybersecurity arsenal: 12,663 tools across 50 categories, built for Kali Linux, by NeoZ" width="840">
...
| | |
|---|---|
| **The whole ecosystem** | **12,663 tools** across **50 categories** — OSINT, web, wireless, exploitation, forensics, reversing, crypto, cloud, Active Directory, mobile, IoT, CTF, honeypots, threat hunting, blue team and far more. |
...
## The Arsenal — 50 categories, 12,663 tools
