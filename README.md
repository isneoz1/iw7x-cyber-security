...
**iw7x** brings **13,023** offensive & defensive security tools — from Nmap to BloodHound, Metasploit to Volatility — into a single command‑line arsenal that **installs, updates and launches** any of them for you. Built for Kali Linux. Free forever.
...
[![Tools](https://img.shields.io/badge/Tools-13%2C023-FF47B3?style=for-the-badge&labelColor=1a1a2e)](catalog.json)
[![Categories](https://img.shields.io/badge/Categories-50-9652FF?style=for-the-badge&labelColor=1a1a2e)](#the-arsenal--50-categories-13023-tools)
...
<img src="assets/iw7x-preview.svg" alt="iw7x — cybersecurity arsenal: 13,023 tools across 50 categories, built for Kali Linux, by NeoZ" width="840">
...
| | |
|---|---|
| **The whole ecosystem** | **13,023 tools** across **50 categories** — OSINT, web, wireless, exploitation, forensics, reversing, crypto, cloud, Active Directory, mobile, IoT, CTF, honeypots, threat hunting, blue team and far more. |
...
python3 neoz.py bundle osint          # OSINT recon kit  ·  also: wireless, pwn, forensics, cloud, passwords, c2, mobile, recon
```
...
## The Arsenal — 50 categories, 13,023 tools
