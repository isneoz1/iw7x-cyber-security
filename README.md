...
**iw7x** brings **14,475** offensive & defensive security tools — from Nmap to BloodHound, Metasploit to Volatility — into a single command‑line arsenal that **installs, updates and launches** any of them for you. Built for Kali Linux. Free forever.
...
[![Tools](https://img.shields.io/badge/Tools-14%2C475-FF47B3?style=for-the-badge&labelColor=1a1a2e)](catalog.json)
[![Categories](https://img.shields.io/badge/Categories-52-9652FF?style=for-the-badge&labelColor=1a1a2e)](#the-arsenal--52-categories-14475-tools)
...
<img src="assets/iw7x-preview.svg" alt="iw7x — cybersecurity arsenal: 14,475 tools across 52 categories, built for Kali Linux, by NeoZ" width="840">
...
| | |
|---|---|
| **The whole ecosystem** | **14,475 tools** across **52 categories** — OSINT, web, wireless, exploitation, forensics, reversing, crypto, cloud, Active Directory, mobile, IoT, CTF, honeypots, threat hunting, blue team and far more. |
...
## The Arsenal — 52 categories, 14,475 tools
