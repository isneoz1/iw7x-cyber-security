...
[![Categories](https://img.shields.io/badge/Categories-53-9652FF?style=for-the-badge&labelColor=1a1a2e)](#the-arsenal--53-categories-28376-tools)
...
<img src="assets/iw7x-preview.svg" alt="iw7x — cybersecurity arsenal: 28,376 tools across 53 categories, built for Kali Linux, by NeoZ" width="840">
...
| | |
|---|---|
| **The whole ecosystem** | **28,376 tools** across **53 categories** — OSINT, web, wireless, exploitation, forensics, reversing, crypto, cloud, Active Directory, mobile, IoT, CTF, honeypots, threat hunting, blue team and far more. |
...
## The Arsenal — 53 categories, 28,376 tools
